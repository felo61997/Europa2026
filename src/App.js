...
export default function App() {
  ...
  async function submitForm() {
    if (!form.date || !form.desc.trim() || !form.amount || isNaN(+form.amount) || +form.amount <= 0) {
                            ...
                            <div style={{ display:"flex", justifyContent:"space-between",
                              ...
                              <div style={{ textAlign:"right", flexShrink:0 }}>
                                ...
                                <button onClick={()=>handleDelete(t.id)} style={{
                                  ...
                                  cursor:"pointer", fontSize:"0.9rem", marginTop:4, padding:0 }}>×</button>
                              </div>
                            </div>
                          </div>
                        );
        ...
        <div style={{ position:"fixed", inset:0, background:"rgba(0,0,0,.75)", zIndex:600,
          ...
          <div style={{ background:C.card, borderRadius:"16px 16px 0 0",
            ...
            <div style={{ fontFamily:"Georgia,serif", fontSize:"1.05rem",
              color:C.accent, marginBottom:18 }}>➕ Nuevo gasto</div>
            ...
            <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:12, marginBottom:12 }}>
              ...
              <div>
                ...
                <div style={{ display:"flex", gap:6 }}>
                  <input ref={amountRef} type="number" value={form.amount}
                ...
                {form.currency !== "USD" && form.amount > 0 && (
                  <div style={{ fontSize:"0.65rem", color:C.muted, fontFamily:"monospace", marginTop:3 }}>
                    ≈ USD {fmtD(toUSD(parseFloat(form.amount)||0, form.currency, rates))}
                  </div>
                )}
              </div>
            </div>
            ...
            <div style={{ display:"flex", gap:10 }}>
              <button onClick={() => { setModal(false); setFormErr(""); }}
